...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${ scrolled || isMenuOpen ? 'bg-dark-bg/90 backdrop-blur-lg border-b border-white/10 shadow-lg' : 'bg-transparent' }`}>
